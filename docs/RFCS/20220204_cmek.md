...
| --- | --- | --- | --- |
| status_filter [post-MVP] | CMEK Status<br>string | If true, return information about all CMEKs regardless of status, including ones that are DISABLED. | `[true\|false]` |
...
Enabling CMEK with the provided per-region CMEKs (see usability discussion on slack).
